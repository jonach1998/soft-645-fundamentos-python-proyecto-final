...
def mostrar_fecha_inicio():
    ...
    print("=" * 55)
    print("Sistema de Estadísticas de Edades".center(55))
    print("Colegio San Pascualin".center(55))
    print("-" * 55)
    print("Desarrollado por:".center(55))
    print("Esteban Davila · Joel Mora · Jonathan Chavarria".center(55))
    print("Paola Ugalde · Sebastian Delgado".center(55))
    print("=" * 55)
